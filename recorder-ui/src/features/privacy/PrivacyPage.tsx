...
Yleisradio Oy:n (Yle) yhteistyönä. Valtion kehitysyhtiö Vake Oy 
(Vake, nyk. Ilmastorahasto) oli mukana käynnistämässä hanketta 
...
kerättävän teknisen tiedon osalta. Mukana ollessaan myös Vake oli 
...
tällä sivulla annetut tiedot perustuvat.`,
    ...
    "remove-p-1": "Lahjoituksesi voit poistaa tietokannasta ottamalla yhteyttä osoitteeseen",
    "remove-p-2": "ja kertomalla heille tunnisteesi sekä ilmaisemalla tahtosi poistaa lahjoituksesi tietokannasta.",
    "your-code": "Ota talteen selainkohtainen tunnisteesi:",
    "clear-browser-h4": "Lahjoittamiseen liittyvien tietojen poistaminen selaimesta",
...
2021 asti myös Valtion kehitysyhtiö Vake Oy (nyk. Ilmastorahasto).`,
...
yhteyttä osoitteeseen`,
    "registry-keepers-contact-p": "Rekisterinpitäjien tietosuojayhteyshenkilöiden tiedot:",
    "registry-keepers-responsibilities-h5": "Rekisterinpitäjien vastuut henkilötietojen käsittelyssä",
    "registry-keepers-responsibilities-p-1": `Lahjoita puhetta -kampanjan ja puheen keräämisen ovat suunnitelleet 
yhdessä Helsingin yliopisto, Valtion kehitysyhtiö Vake Oy (nyk. Ilmastorahasto) 
ja Yleisradio. Toteuttajina olivat vuonna 2020 Helsingin yliopisto, Vake 
...
teknisen tiedon käsittelystä. Vaken vastuulla oli vuonna 2020 erityisesti Lahjoita 
...
Tietoa tasapainotestistä ja sen huomioista löytyy`,
    ...
    "legal-basis-p-2": ".",
    "personal-info-who-h4": "Keitä ovat henkilötietojen vastaanottajat tai vastaanottajaryhmät?",
...
valvontaviranomaisen vahvistamat yritystä koskevat sitovat säännöt.`,
    "how-long-h4": "Kuinka kauan tietoja säilytetään tai millä kriteerillä säilytysaika määrittyy?",
...
tietojasi käsittelemme.`,
    "your-rights-p-2-1": "Sinulla on oikeus vaatia virheellisen tiedon korjaamista ottamalla meihin yhteyttä.",
...
const sv_strings = {
    ...
    "your-rights-p-1": "Du har rätt att få veta om vi behandlar dina personuppgifter. Om vi behandlar dina personuppgifter, har du rätt att få veta vilka uppgifter vi behandlar.",
    "your-rights-p-2-1": "Du har rätt att begära rättelse av felaktiga uppgifter genom att kontakta oss.",
    "your-rights-p-2-2": "Du kan be oss att ta bort din personinformation från våra system. Vi kommer att vidta åtgärder på din begäran, om vi inte har någon berättigad orsak att låta bli att radera informationen. Data raderas inte nödvändigtvis omedelbart från alla våra säkerhetskopior eller liknande system.",
    "your-rights-p-3": "Informationen som samlas in genom kampanjen Donera tal används inte för direkt marknadsföring till taldonatorer eller för automatiskt beslutsfattande om taldonatorer.",
    "your-rights-p-4": "Du kan be oss begränsa behandlingen av vissa av dina personuppgifter. En begäran om att begränsa behandlingen av uppgifter kan leda till mer begränsade möjligheter att använda talet du donerar för att utveckla artificiell intelligens.",
    "your-rights-p-5": "Du kan invända mot behandlingen av dina personuppgifter utifrån din specifika personliga situation, det vill säga begära att de inte behandlas alls. I så fall kommer vi att sluta behandla dina uppgifter om vi inte kan påvisa att det finns en ytterst viktig och välgrundad orsak för behandlingen, som åsidosätter dina intressen, rättigheter och friheter, eller att behandlingen är nödvändig för att fastställa, framlägga eller försvara ett rättsligt anspråk.",
    "your-rights-p-6": "Du har rätt att klaga till Dataskyddsombudet om du anser att behandlingen av dina personuppgifter bryter mot lagen. Mer information om överklaganderätten",
...
const PrivacyPage: React.FC<PrivacyPageProps> = ({lang}) => {
    ...
    var DATAPROTECTION_URL = lang !== "sv" ? "https://tietosuoja.fi/onko-tietosuojaoikeuksiasi-loukattu": "https://tietosuoja.fi/sv/har-dina-dataskyddsrattigheter-krankts"
    var registry_keepers_contact = lang !== "sv" ?
	<ul className="mb-4">
        <li>
        ...
        <li>
          Valtion kehitysyhtiö Vake Oy (nyk. Ilmastorahasto):
          {"  "}
	...
	var personal_info_who_p_2 = lang !== "sv" ?
	<p className="mb-4">
    ...
    <p className="mb-4">
    Vid lagring och behandling av talmaterial använder Helsingfors universitet CSC – Tieteen tietotekniikan keskus Oy som personuppgiftsbiträde.
        {" ("}
        <a href="mailto:asiakaspalvelu@csc.fi">asiakaspalvelu@csc.fi</a>
        {", PB "}
        405, 02101 Esbo). I det tekniska genomförandet av insamlingen och lagringen av uppgifter används Googles Firebase- och Amazon Web Services-tjänster som underleverantörer.
    </p>
  ...
  return (
    <div className="privacy-page frame--view">
	  ...
	  <p className="mb-4">
	  {s["registry-keepers-responsibilities-p-1"]}
      </p>

	  <p className="mb-4">
	  {s["registry-keepers-responsibilities-p-2"]}
      </p>
	...
	<p className="mb-4">
	{s["what-personal-info-p-1"]}
      </p>

	<p className="mb-4">
	{s["what-personal-info-p-2"]}
      </p>
	  ...
	  {s["legal-basis-p-1"]}
        {"  "}
          <a href={lang !== "sv" ? balanceTest: balanceTestSv} target="_blank" rel="noopener noreferrer">
          {s["legal-basis-here"]}
        </a>
	  {s["legal-basis-p-2"]}
      </p>
