...
const fi_strings: Langstrings = {
  ...
  p:
    "Lahjoita puhetta -kampanja toteutetaan Ylen ja Helsingin yliopiston yhteistyönä. Valtion kehitysyhtiö Recorder (nyk. Ilmastorahasto) oli mukana käynnistämässä hanketta vuonna 2020.",
};
...
const sv_strings: Langstrings = {
  h2: "Samarbetspartner",
  p:
    "Kampanjen Donera prat är ett samarbete mellan Yle, Helsingfors universitet och Svenska litteratursällskapet i Finland. Statens utvecklingsbolag Recorder (nuförtiden Klimatfonden) var med och startade motsvarande projekt på finska år 2020.",
};
...
const PartnersPage: React.FC<PartnersPageProps> = ({ lang }) => {
  ...
  return (
    <div className="partners-page frame--view">
      <h2>{langs[lang]["h2"]}</h2>
      <p className="mb-4">{langs[lang]["p"]}</p>
      {partner_icons}
    </div>
  );
};
