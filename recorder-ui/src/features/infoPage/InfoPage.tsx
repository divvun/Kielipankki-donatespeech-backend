...
const fi_strings: Langstrings = {
  ...
  feedback:
    "Mikäli et löydä sivustolta vastausta kysymykseesi tai kohtaat teknisen ongelman, otathan yhteyttä",
  ...
  "faq-p-remove-2":
    "ja kertomalla heille tunnisteesi sekä ilmaisemalla tahtosi poistaa lahjoituksesi tietokannasta. Löydät selainkohtaisen tunnisteesi",
  ...
  "faq-h5-confidentiality":
    "Kuka varmistaa lahjoitetun puheen luottamuksellisen käsittelyn?",
  "faq-p-confidentiality-1":
    "Hankkeen takana seisovat luotettavat yhteiskunnalliset toimijat, kuten Yle, Helsingin yliopisto sekä vuoden 2021 helmikuuhun asti myös Valtion kehitysyhtiö Recorder (nyk. Ilmastorahasto). Yle ja Helsingin yliopisto ovat yhdessä vastuussa puheen keräämisestä, ja Helsingin yliopisto on vastuullinen taho lahjoitetun puheen tallentamisen ja käytön osalta. Mukana ollessaan myös Recorder oli vastuussa puheen keräämisestä yhdessä Ylen ja Helsingin yliopiston kanssa. Helsingin yliopisto voi arvionsa mukaan luovuttaa aineistoa muiden käyttöön myös kaupallisesti tai siirtää puheaineiston kokonaisuudessaan jollekin toiselle organisaatiolle. Luovutukset toteutetaan aina",
  "on-page": "-sivulla",
  "faq-p-confidentiality-2":
    "esitettyjä periaatteita noudattaen, ja aineiston käsittely on luottamuksellista.",
  "faq-h5-use":
...
const sv_strings: Langstrings = {
  ...
  feedback:
    "Kontakta oss om vi inte lyckats svara på dina frågor eller om du stött på ett tekniskt problem: ",
  "faq-h3": "Ofta ställda frågor",
  "faq-h5-why-collect": "Varför samlas pratet in?",
  "faq-p-why-collect":
    "Pratet samlas in för att stödja vetenskaplig forskning av olika slag, bl.a. språkforskning, och för utveckling av program och tjänster som förstår och producerar tal. Med hjälp av det prat som doneras kan man t.ex. utveckla röststyrda program som förstår svenska som sedan till exempel kan användas i äldrevården. För att skapa program som förstår talad svenska behövs en enorm mängd av helt vardagligt tal.",
  "faq-p-why-collect-2":
    "Målet med den här allmännyttiga kampanjen är att garantera att vi i framtiden kan använda tjänster på vårt eget språk, precis så som vi själva talar det. Samtidigt får bl.a. språkforskare tillgång till en stor mängd material som till exempel kan användas inom dialektforskningen och för att undersöka frågor kring uttal, intonation, begreppsanvändning och mycket annat som vi inte ens känner till i dagens läge!",
  "faq-h5-how": "Hur donerar jag mitt prat?",
  "faq-p-how":
    "Du donerar prat genom att följa anvisningarna och göra uppgifterna som kommer fram i olika teman. Kom samtidigt ihåg att det är ditt prat som räknas, inte vad du pratar om, så du behöver inte vara rädd för att prata bredvid ämnet!",
  "faq-h5-what": "Vad menas egentligen med ”prat”?",
  "faq-p-what":
    "”Prat” betyder i det här fallet helt normalt vardagligt tal, med allt vad det innebär. Använd din egen dialekt. Det gör inget om du stakar dig, stammar, tvekar eller håller pauser. Prata precis som du brukar göra!",
  "faq-h5-who": "Vem samlar in pratet?",
  "faq-p-who-1":
    "Donera prat är en kampanj som genomförs av Yle, Helsingfors universitet och Svenska litteratursällskapet i Finland (SLS). Yle, Helsingfors universitet och SLS ansvarar tillsammans för att samla in pratet och Helsingfors universitet och SLS ansvarar för hanteringen och arkiveringen av materialet. Helsingfors universitet och SLS kan ge andra aktörer (även kommersiella)  rätt att använda materialet helt eller delvis. Användningen av materialet  sker i så fall i enlighet med de principer som uppges under rubriken",
  "privacy-word": "Dataskydd",
  "faq-p-who-2": ".",
  "faq-h5-how-much": "Hur mycket prat vill vi samla in?",
  "faq-p-how-much":
    "Projektet strävar efter att samla in över tusen timmar av finlandssvenskt vardagsprat. Den här mängden beräknas göra finlandssvensk taligenkänning betydligt pålitligare. Dessutom vill vi försäkra oss om att få så många olika finlandssvenskar som möjligt från olika håll i landet med i kampanjen.",
  "faq-h5-why-diverse": "Varför behövs alla svenskspråkigas insats?",
  "faq-p-why-diverse":
    "För att kunna skapa program som förstår alla varianter av finlandssvenska krävs en stor mängd material av den svenska som talas av människor i olika åldrar från olika orter i Svenskfinland.",
  "faq-h5-remove": "Kan jag i efterhand radera mitt inspelade prat?",
  "faq-p-remove-1": "Genom att kontakta",
  "faq-p-remove-2":
    "och meddela den identifikationskod som du fått samt berätta att du önskar radera din donation från databasen kan du under insamlingstiden radera pratet du donerat. Identifikationskoden är specifik för ditt donationsformulär och hittas på",
  "privacy-page-word": "Dataskyddssidan",
  "from-page": "",
  "faq-p-remove-4":
    "Dessutom kan den aktör som hanterar materialet vid behov radera inspelat prat eller annan information.",
  ...
  "faq-p-selling":
    "Aktörerna som ansvarar för kampanjen Donera prat kan överlåta eller sälja  inspelat material, transkriberingar eller modeller som genererats ur materialet till inhemska och internationella forskare eller företag som forskar och utvecklar program och tjänster som förstår eller producerar svenskspråkigt tal.",
  "faq-h5-confidentiality":
    "Vem ser till att det prat som doneras behandlas med respekt för mina rättigheter?",
  "faq-p-confidentiality-1":
    "Projektet drivs av pålitliga aktörer såsom Yle, Helsingfors universitet och Svenska litteratursällskapet i Finland (SLS). Yle, Helsingfors universitet och SLS är tillsammans ansvariga över att samla in prat och Helsingfors universitet och SLS ansvarar för hanteringen och arkiveringen av materialet och dess användning. Helsingfors universitet och SLS kan ge andra aktörer (även kommersiella) rätt att använda materialet helt eller delvis. Det sker i så fall alltid enligt principerna på vår",
  "on-page": "",
  "faq-p-confidentiality-2":
    "och materialet behandlas även i fortsättningen med respekt för dina rättigheter.",
  "faq-h5-use":
    "Hur kan jag utnyttja prat som doneras i min egen forskning / i vårt företags program?",
  "faq-p-use":
    "Allt inspelat prat hanteras av Helsingfors universitet och SLS som i sin tur kan överlåta materialet till vetenskaplig forskning  eller till företag  som forskar och utvecklar program och tjänster som förstår eller producerar svenskspråkigt tal. Materialet överlåts via Språkbanken eller SLS.",
  "faq-h5-what-do-i-get": "Vad får jag ut av att donera prat?",
  "faq-p-what-do-i-get":
    "I och med att digitaliseringen fortsätter utvecklas och många av våra tjänster i framtiden kommer att styras av artificiell intelligens är det viktigt att teknologin förstår användarna på deras eget språk. Följden är att alla får en enklare vardag i framtiden. Dessutom är det roligt att donera prat.",
  "faq-h5-nonnative":
    "Kan jag donera prat fastän svenska inte är mitt modersmål?",
  "faq-p-nonnative":
    "Så klart! Ju mångsidigare svenskt prat vi samlar in, desto mer nytta har vi av materialet inom forskningen och utvecklingen av röststyrda program och appar - samtidigt som framtida tjänster förstår oss svensktalande på allt fler olika sätt.",
};
...
const InfoPage: React.FC<InfoPageProps> = ({ lang }) => {
  ...
  var mailto =
    lang !== "sv" ? (
      ...
      <a href="mailto:donaraprat@kielipankki.fi">doneraprat@kielipankki.fi</a>
    );

  var mobile_remove =
    lang === "fi" ? (
      <span>
        Mobiilisovellusta käytettäessä asennuskohtainen tunnisteesi löytyy
        {"  "}
  ...
  return (
    <div className="info-page frame--view">
      <h2>{s["h2"]}</h2>
      <p className="mb-4">{s["p-1"]}</p>
      <p className="mb-4">{s["p-2"]}</p>
      <p className="mb-4">{s["p-3"]}</p>
      <p className="mb-4">
      ...
      <h5>{s["faq-h5-how"]}</h5>
      <p className="mb-4">{s["faq-p-how"]}</p>

      <h5>{s["faq-h5-what"]}</h5>
      <p className="mb-4">{s["faq-p-what"]}</p>
      ...
      <p className="mb-4">{s["faq-p-why-collect"]}</p>
      <p className="mb-4">{s["faq-p-why-collect-2"]}</p>

      <h5>{s["faq-h5-how-much"]}</h5>
      <p className="mb-4">{s["faq-p-how-much"]}</p>

      <h5>{s["faq-h5-why-diverse"]}</h5>
      <p className="mb-4">{s["faq-p-why-diverse"]}</p>

      <h5>{s["faq-h5-what-do-i-get"]}</h5>
      <p className="mb-4">{s["faq-p-what-do-i-get"]}</p>

      <h5>{s["faq-h5-nonnative"]}</h5>
      <p className="mb-4">{s["faq-p-nonnative"]}</p>
      ...
      <p className="mb-4">{s["faq-p-remove-4"]}</p>

      <h5>{s["faq-h5-privacy"]}</h5>

      <p className="mb-4">{s["faq-p-privacy-1"]}</p>

      <p className="mb-4">{s["faq-p-privacy-2"]}</p>

      <h5>{s["faq-h5-secrecy"]}</h5>
      <p className="mb-4">{s["faq-p-secrecy"]}</p>

      <h5>{s["faq-h5-bio-record"]}</h5>
      <p className="mb-4">{s["faq-p-bio-record"]}</p>
      ...
      <p className="mb-4">{s["faq-p-selling"]}</p>
      ...
      <h5>{s["faq-h5-use"]}</h5>
      <p className="mb-4">{s["faq-p-use"]}</p>
    </div>
  );
};
