...
export class RecorderStaticSite extends cdk.Stack {
  constructor(
    ...
    const s3Policy = new s3.BucketPolicy(this, "SiteBucketPolicy", {
      bucket: siteBucket,
    });
    ...
    oaiPolicyStatement.addResources(`${siteBucket.bucketArn}/*`);
    oaiPolicyStatement.addCanonicalUserPrincipal(
    ...
    new cdk.CfnOutput(this, "DistributionIdOut", {
