...
| URL | Meaning |
|-----|---------|
|lahjoitapuhetta.fi| The main production site |
|endpoint.lahjoitapuhetta.fi | APIs for the production envirnoment |
|dev.lahjoitapuhetta.fi | The development site |
|endpoint.dev.lahjoitapuhetta.fi. | The development APIs |

Each directory contains it's own readme file with detailed information.
...
| File | Purpose |
|------|---------|
|[serverless_build_spec.yml](serverless_build_spec.yml)| is the CI commands to build the needed infrastructure and backend resources including the UI static files.|
